...
function readConfig() {
  ...
  return {
    ...
    telegramTokenFile: readTextEnv("CYBERBOSS_TELEGRAM_TOKEN_FILE") || path.join(stateDir, "telegram-bot-token"),
    telegramOffsetFile: path.join(stateDir, "telegram-offset"),
    ...
    outboundDeliveryFile: path.join(stateDir, "outbound-deliveries.json"),
    outboundTokenRegistryFile: path.join(stateDir, "outbound-token-registry.json"),
    outboundMediaDir: path.join(stateDir, "outbound-media"),
    ...
    recentMemoryDays: readIntEnv("CYBERBOSS_RECENT_MEMORY_DAYS") || 7,
    recentMemoryMaxChars: readIntEnv("CYBERBOSS_RECENT_MEMORY_MAX_CHARS") || 16000,
    threadVolumeDays: readIntEnv("CYBERBOSS_THREAD_VOLUME_DAYS") || 7,
